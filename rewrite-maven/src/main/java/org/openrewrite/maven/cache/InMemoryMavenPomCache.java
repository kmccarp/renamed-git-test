...
public class InMemoryMavenPomCache implements MavenPomCache {
    ...
    public InMemoryMavenPomCache(String cacheNickname,
        ...
        CaffeineCacheMetrics.monitor(Metrics.globalRegistry, pomCache, "Maven POMs", "cache.nickname", cacheNickname);
        CaffeineCacheMetrics.monitor(Metrics.globalRegistry, mavenMetadataCache, "Maven metadata", "cache.nickname", cacheNickname);
        CaffeineCacheMetrics.monitor(Metrics.globalRegistry, repositoryCache, "Maven repositories", "cache.nickname", cacheNickname);
        CaffeineCacheMetrics.monitor(Metrics.globalRegistry, dependencyCache, "Resolved dependency POMs", "cache.nickname", cacheNickname);
    }
