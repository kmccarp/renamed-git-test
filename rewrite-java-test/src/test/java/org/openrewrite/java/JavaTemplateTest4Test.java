        ...
        rewriteRun(
          spec -> spec.recipe(toRecipe(() -> new JavaIsoVisitor<>() {
              ...
              assertThat(type.getParameterTypes().get(1))
                .matches(jt -> jt instanceof JavaType.Parameterized p
                               && p.getType().getFullyQualifiedName().equals("java.util.List")
                               && p.getTypeParameters().size() == 1
                               && TypeUtils.asFullyQualified(p.getTypeParameters().getFirst()).getFullyQualifiedName().equals("java.lang.String"),
