...
public class IsInRepository extends Recipe {
    ...
    public String getDescription() {
        return """
               A search recipe which marks files that are in a repository with one of the supplied names. \
    ...
    @Option(displayName = "Allowed repositories",
            description = """
                          The names of the repositories that are allowed to be searched. \
