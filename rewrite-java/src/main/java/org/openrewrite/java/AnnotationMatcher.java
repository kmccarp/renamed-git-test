 ...
 * {@literal @}myhttp.Get(path="recentPayments", serviceName="payments")  - Exactly the samuel e results from the previous example, order of parameters does not matter.
